...
const EquipoDisponibilidad: React.FC<EquipoDisponibilidadProps> = ({ idVisita }) => {
  ...
  if (equipoDisponibleExistente) {
    return <EquipoDisponibilidadVer idVisita={idVisita} />;
  }

  if (esperaDisponibilidadExistente) {
    return <EquipoDisponibilidadEsperaVer idVisita={idVisita} />;
  }
  ...
  return (
    <div className="EquipoDisponibilidad-visita-actividad">
      {!equipoDisponibleExistente || !esperaDisponibilidadExistente && (
